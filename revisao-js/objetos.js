...
/*
    for..in determina quais propriedades de um objeto e coloca cada uma delas em uma variável 
    informada pelo usuário (p, no caso) a cada iteração do loop
    LISTA DE PROPRIEDADES DE UM OBJETO
*/
for(let p in pessoa) {
    console.log(p)
}
