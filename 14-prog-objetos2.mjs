...
// Por convenção, nomes de classe em JS se iniciam com letras maiúsculas
class FormaGeometrica {
    ...
    constructor(base, altura, tipo) {
        ...
        // Base deve ser númerica e seu valor maior que zero
        ...
        */
        ...
        // ATRIBUTOS PRIVADOS: só podem ser acessador e modificados DENTO da classe
        this.#base = base
        this.#altura = altura
        this.#tipo = tipo
...
catch(erro) {   // O bloco catch() recee o erro que foi gerado no bloco try
    // Tratamento de exceção; Nesse caso, exibiremos a mensagem de erro
    console.log('ERRO:' + erro.message)
}
...
// Alterando valor de um atributo do objeto DEPOIS de sua criação
