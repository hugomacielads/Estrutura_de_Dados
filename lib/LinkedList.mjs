/*
    ...
    - Cada nodo da lista encadeada tem duas partes: uma, que armazena
      a informação e outra que guarda o endereço do próxixmo nodo da
      sequência
    - A qualquer momento, temos um conhecimento apenas limitado de onde
      se encontram todos os nodos da lista.
      Sabemos apenas onde está o primeiro e o último nodo da sequência
      Os nodos intermediários precisam ser encontrados partindo-se do
...
class Node {
    constructor(val) {
        ...
        this.next = null   // Ponteiro para o próximo nome
    }
}
