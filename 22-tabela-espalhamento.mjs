...
function qualLista(val) {
    ...
    if (typeof val === 'number') return val % 10
        ...
        for(let i = 0; i < val.length; i++) {
            // Soma dos valores numéricos correspondentes a cada caractere
            soma += val.charCodeAt(i)
        }
        // console.log({soma, val})
        return soma % 10
    }
}
...
console.log('Total de itens inseridos na lista', tabela.count)